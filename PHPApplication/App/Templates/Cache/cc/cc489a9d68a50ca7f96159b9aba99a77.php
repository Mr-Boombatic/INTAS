...
class __TwigTemplate_b59e88f213d6ad772c6d9cb204d8ee78 extends Template
{
...
<head>
    ...
    <style>
        ...
        select {
            appearance: none; /* Для удаления стандартного выпадающего списка */
...
<form id=\"scheduleForm\">
    ...
    <select id=\"region\" name=\"region\" onchange=\"calculateArrivalDate()\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["region"]) {
            // line 80
            yield "            <option value=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["region"], "regionName", [], "any", false, false, false, 80), "html", null, true);
            yield "\" data-duration=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["region"], "duration", [], "any", false, false, false, 80), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["region"], "regionName", [], "any", false, false, false, 80), "html", null, true);
            yield " (";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["region"], "duration", [], "any", false, false, false, 80), "html", null, true);
...
<script>
    ...
    document.getElementById(\"scheduleForm\").addEventListener(\"submit\", function(event) {
        ...
        fetch('http://localhost/api/create_route', {
            method: 'POST',
            headers: {
    ...
    {
        return array (  141 => 82,  126 => 80,  122 => 79,  42 => 1,);
    }
...
</html>", "create_route.html.twig", "/var/www/html/public/App/Templates/create_route.html.twig");
    }
}
