...
/* list.html.twig */
class __TwigTemplate_5ffff89099ec52dc6de08670e8e80c7b extends Template
{
...
<script>
    document.getElementById('dateForm').addEventListener('submit', function (event) {
        ...
        const submitButton = document.getElementById('submitButton'); // Измените ID как нужно
        submitButton.disabled = true;

        fetch(`http://localhost/api/route/list/\${date}`)
            .then(response => {
                if (!response.ok) {
...
</html>", "list.html.twig", "/var/www/html/public/App/Templates/list.html.twig");
    }
}
